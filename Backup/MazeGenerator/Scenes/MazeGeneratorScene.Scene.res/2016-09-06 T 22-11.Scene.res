<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
              ...
              <_items dataType="Array" type="Duality.Component[]" id="1251002212" length="4">
                ...
                <item dataType="Struct" type="Duality.Plugins.Tilemaps.Tilemap" id="647548177">
                  ...
                  <tileData dataType="Struct" type="Duality.Plugins.Tilemaps.TilemapData" id="1617167277" custom="true">
                    <body>
                      <version dataType="Int">2</version>
                      <data dataType="Array" type="System.Byte[]" id="1146402150"></data>
                    </body>
                  </tileData>
                  <tileset dataType="Struct" type="Duality.ContentRef`1[[Duality.Plugins.Tilemaps.Tileset]]">
        ...
        <_items dataType="Array" type="Duality.Component[]" id="3416807056" length="4">
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.TextRenderer" id="3629335426">
            ...
            <text dataType="Struct" type="Duality.Drawing.FormattedText" id="1252654874">
              ...
              <maxHeight dataType="Int">0</maxHeight>
              <maxWidth dataType="Int">0</maxWidth>
              <sourceText dataType="String">1:36</sourceText>
              <wrapMode dataType="Enum" type="Duality.Drawing.FormattedText+WrapMode" name="Word" value="1" />
            </text>
            <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0" value="1" />
          </item>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="335434110">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="2848302120">
        <_items dataType="Array" type="Duality.GameObject[]" id="4139824556" length="4">
          ...
          <item dataType="Struct" type="Duality.GameObject" id="4139651320">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4214430288">
              <_items dataType="Array" type="Duality.Component[]" id="126119356" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="2204998956">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <angleVel dataType="Float">0</angleVel>
                  <angleVelAbs dataType="Float">0</angleVelAbs>
                  <deriveAngle dataType="Bool">true</deriveAngle>
                  <gameobj dataType="ObjectRef">4139651320</gameobj>
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <parentTransform />
                  <pos dataType="Struct" type="Duality.Vector3" />
                  <posAbs dataType="Struct" type="Duality.Vector3" />
                ...
                <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="1486850592">
                  <active dataType="Bool">true</active>
                  <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
                    <A dataType="Byte">255</A>
                    <B dataType="Byte">255</B>
                  ...
                  <rectMode dataType="Enum" type="Duality.Components.Renderers.SpriteRenderer+UVMode" name="Stretch" value="0" />
                  <sharedMat dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
                    <contentPath dataType="String">Data\MazeGenerator\Images\Menu\lose.Material.res</contentPath>
                  </sharedMat>
                  <visibilityGroup dataType="Enum" type="Duality.Drawing.VisibilityFlag" name="Group0" value="1" />
                </item>
              </_items>
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2204044654" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="2900647714">
                  <item dataType="ObjectRef">3307113422</item>
                  <item dataType="ObjectRef">4028630822</item>
                </keys>
                <values dataType="Array" type="System.Object[]" id="2676915978">
                  <item dataType="ObjectRef">2204998956</item>
                  <item dataType="ObjectRef">1486850592</item>
                </values>
              </body>
            </compMap>
            <compTransform dataType="ObjectRef">2204998956</compTransform>
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="1215235282">L1yE9TpiAEyR9GFi40rm1w==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    ...
    <item dataType="ObjectRef">4139651320</item>
  </serializeObj>
